...
\newcommand{\requirementTable}[5]{
    \begin{table}[H]
      \begin{tabularx}{\textwidth}{|l|X|}
        \hline
        Bezeichnung & \makecell[l]{#1}  \\ \hline
        Akteur (= Auslöser) & \makecell[l]{#2}  \\ \hline
        Voraussetzung & \makecell[l]{#3}  \\ \hline
        Funktionsablauf & \makecell[l]{#4}  \\ \hline
        Endzustand & \makecell[l]{#5}  \\ \hline
      \end{tabularx}
    \end{table}
}
  ...
  \section{Zielkatalog}
    ...
    \subsection{Funktionale Anforderungen}
      \subsubsection{Anforderungen aus der Sicht des unprivilegierten Benutzers}
        \requirementTable{asdf}{asdf}{asdf}{asdf}{asdf}
